package ir.negra.legalbill.utilities;
...
public class StaticFunctions {
    ...
    public static TextWatcher TextChangeForChangeBack(
            final LinearLayout layout, final EditText editText) {//________________ Satart TextChangeForChangeBack
